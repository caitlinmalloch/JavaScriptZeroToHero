...
/*
////////////////////////////////////////////////////////////////////////
// SPLIT AND JOIN Strings, Capitalize
console.log('a+very+nice+string'.split('+'));
console.log('Caitlin Malloch'.split(' '));

const [firstName, lastName] = 'Caitlin Malloch'.split(' ');
...
capitalizeName('caitlin malloch');
capitalizeName('random name');
...
console.log(maskCreditCard(4333333232438203480));
console.log(maskCreditCard(795743705684760986879));
...
const passenger = 'cAiT'; // cAiT
const passengerLower = passenger.toLowerCase();
const passengerCorrect =
  passengerLower[0].toUpperCase() + passengerLower.slice(1);
console.log(passengerCorrect); // Cait

// Comparing emails
const email = 'hello@email.io';
const loginEmail = ' Hello@Email.Io \n';
...
console.log(announcement.replaceAll('door', 'gate')); // replace all instances
...
console.log(new String('Cait'));
console.log(typeof new String('Cait'));

console.log(typeof new String('Cait').slice(1));
